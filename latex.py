...
try:
    ...
    latex_equivalents.update(u2l.getconversion())
except ImportError:
    print "Latex codec was unable to load the extended dictionary."
    print "We will use the shorter, embedded, version."
    print "In case of missing chars, you should add the unicode2latex library"
    pass
